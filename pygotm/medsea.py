...
def prepare_run(start,stop,out_dir,out_fn='results',m=None,n=None,lat=None,lon=None, **gotm_user_args):
    ...
    print('Copying: ',os.path.join(GOTM_nml_path,grid_file))
    print('To:', os.path.join(out_dir,grid_file))
    shutil.copyfile(os.path.join(GOTM_nml_path,grid_file),os.path.join(out_dir,grid_file))
...
#    local_folder = get_local_folder(lat,lon,run)
    local_folder = get_local_folder(m=m,n=n,new_run=run,create=create)
