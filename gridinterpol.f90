...
! !INPUT PARAMETERS:
   ...
   double precision, intent(in)                :: obs_z(0:N),obs_prof(0:N,cols)
   integer,  intent(in)                :: nlev
   double precision, intent(in)                :: model_z(0:nlev)
!
! !OUTPUT PARAMETERS:
   double precision, intent(out)               :: model_prof(0:nlev,cols)
!
! !REVISION HISTORY: 
...
! !LOCAL VARIABLES:
   ...
   double precision                  :: z,w0,w1,w2,r1,r2 
! 
!-----------------------------------------------------------------------
!BOC
