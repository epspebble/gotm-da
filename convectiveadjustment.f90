...
! !INPUT PARAMETERS:
   ...
   double precision, intent(in)                :: g,rho_0
   double precision, intent(in)                :: const_num,const_nuh
!
! !OUTPUT PARAMETERS:
   double precision, intent(out)               :: num(1:nlev),nuh(1:nlev)
!
! !REVISION HISTORY:
...
! !LOCAL VARIABLES:
   integer                   :: i,ii
   double precision                  :: hint,Tint,Sint
   double precision                  :: buoyupp,buoylow,buoyint
